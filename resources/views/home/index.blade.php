    ...
    <form action="{{ route('home')}}" method="POST">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <p class="mt-1 text-sm leading-6 text-gray-600">Vous pouvez modifier votre mot de passe.</p>
                ...
                <x-input type="password" name="password_confirmation" label="Confirmation de nouveau mot de passe"  />
                </div>
            </div>
